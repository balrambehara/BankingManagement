...
<tr >
	<td width="300" valign="top" style="border-right:#666666 1px dotted;">
    	<div id="services"><h1>Services</h1><br>
		    <ul>
        	<li><a href="#">www.myonlinebank.com</a></li>
            <li><a href="#">www.myonlinebankservice.com </a></li>
            <li><a href="#">www.myonlinebankinsurance.com</a></li>
            </ul>
...
<table><%
		...
		if(status==true){
			...
			if(rs3.next()){
				request.setAttribute("insufficientBal","no");
			request.setAttribute("target account A",dataamount);
			request.setAttribute("account B",dataamount1);	
			request.getRequestDispatcher("tbalance.jsp").forward(request, response);
			...
			*/
			...
			<% 
			 ...
			 if(e.getErrorCode()==2290){
				 request.setAttribute("target account A "," balance can't transfer");
					request.setAttribute("account B"," insufficient fund");	
					request.setAttribute("insufficientBal","yes");
					request.getRequestDispatcher("tbalance.jsp").forward(request, response);
